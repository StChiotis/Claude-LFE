...
Create an Architectural Decision Record — a **product** decision in `.docs/architecture/architecture-decisions.md`, a **framework** decision in `framework-decisions.md` (see [ADR-FORMAT.md](./ADR-FORMAT.md)) — ONLY when all three are true:
