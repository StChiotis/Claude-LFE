...
## Handoff
Return control to `/lfe-inspector`. Inspector aggregates this file's content into `critique.md` under a `## Security` section. Write only this findings file; leave `critique.md` to the Inspector.
